...
export const translations: Record<LanguageCode, Record<string, string>> = {
  ...
  // English keys fallback for other languages (shortened for space, should repeat pattern)
  ...
  as: { dashboardTitle: "ন্যায়দৃষ্টি", loginTitle: "স্বাগতম", aiAssistantTitle: "ন্যায়দৃষ্টি AI সহায়ক", typeMessage: "বাৰ্তা টাইপ কৰক..." },
