...
export function CourtDetailsTable() {
  ...
  const courtNamesMap: Record<string, Record<string, string>> = {
    "hi": { "Supreme Court": "सुप्रीम कोर्ट", "Allahabad": "इलाहाबाद", "Madras": "मद्रास", "Bombay": "बॉम्बे", "Delhi": "दिल्ली" },
    // Simplified mapping for demonstration; ideally all names would be in translations.ts
  };
